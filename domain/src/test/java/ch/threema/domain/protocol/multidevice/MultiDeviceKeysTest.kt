...
class MultiDeviceKeysTest {
    ...
    fun testEncryptTransactionScope() {
        ...
        listOf(
            ...
            val nonce = encrypted.copyOfRange(0, NaCl.NONCE_BYTES)
            val data = encrypted.copyOfRange(NaCl.NONCE_BYTES, encrypted.size)
    ...
    fun testDecryptTransactionScope() {
        ...
        listOf(
            ...
            val encrypted = nonce + NaCl.symmetricEncryptData(data = bytes, key = keys.dgtsk, nonce = nonce)
