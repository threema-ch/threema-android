...
import ch.threema.domain.protocol.csp.messages.GroupReactionMessage.Companion.fromByteArray
import ch.threema.domain.protocol.csp.messages.GroupReactionMessage.Companion.fromReflected
...
class GroupReactionMessage(
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromReflected(message: IncomingMessage): GroupReactionMessage {
        ...
        @JvmStatic
        fun fromReflected(message: OutgoingMessage): GroupReactionMessage {
            val groupReactionMessage = fromByteArray(message.body.toByteArray())
            groupReactionMessage.initializeCommonProperties(message)
            return groupReactionMessage
        }
