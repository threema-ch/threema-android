...
public interface ForwardSecurityStatusListener {
	...
	void rejectReceived(@NonNull ForwardSecurityDataReject rejectData, @NonNull Contact contact, boolean sessionUnknown);
	...
	void sessionBadState(@NonNull DHSessionId sessionId, @NonNull Contact contact);
	void sessionTerminated(@NonNull DHSessionId sessionId, @NonNull Contact contact);
	...
	void messageDecryptionFailed(@NonNull DHSessionId sessionId, @NonNull Contact contact, @Nullable MessageId failedMessageId);
	void first4DhMessageReceived(@NonNull DHSession session, @NonNull Contact contact);
	void unexpectedAppliedVersion(@NonNull DHSession session, int appliedVersion, @NonNull Contact contact);
	void negotiatedVersionUpdated(@NonNull DHSession session, @NonNull Version updatedNegotiatedVersion, @NonNull Contact contact);
