...
public class JSONObject {
    ...
    public JSONObject(@NotNull Map copyFrom) {
        this();
     ...
     *                       {@code JSONObject}.
     */
    public JSONObject(@NotNull JSONTokener readFrom) throws JSONException {
        /*
     ...
     *                       JSONObject}.
     */
    public JSONObject(@NotNull String json) throws JSONException {
     ...
     * be skipped.
     */
    public JSONObject(@NotNull JSONObject copyFrom, @NotNull String[] names) throws JSONException {
        this();
     ...
     */
    @NotNull
    public JSONObject put(@NotNull String name, boolean value) throws JSONException {
     ...
     */
    @NotNull
    public JSONObject put(@NotNull String name, double value) throws JSONException {
     ...
     */
    @NotNull
    public JSONObject put(@NotNull String name, int value) throws JSONException {
        nameValuePairs.put(checkName(name), value);
        return this;
    }
     ...
     */
    @NotNull
    public JSONObject put(@NotNull String name, long value) throws JSONException {
        nameValuePairs.put(checkName(name), value);
        return this;
    }
     ...
     */
    @NotNull
    public JSONObject put(@NotNull String name, @Nullable Object value) throws JSONException {
        if (value == null) {
     ...
     */
    @NotNull
    public JSONObject accumulate(@NotNull String name, @Nullable Object value) throws JSONException {
     ...
     */
    @NotNull
    public String optString(@Nullable String name, @NotNull String fallback) {
        Object object = opt(name);
        String result = JSON.toString(object);
        return result != null ? result : fallback;
    }
