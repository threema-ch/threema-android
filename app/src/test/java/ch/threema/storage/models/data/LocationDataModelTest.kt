...
class LocationDataModelTest {
    ...
    private val testCasesToString: List<Pair<LocationDataModel, String>> = listOf(
        ...
        LocationDataModel(
            ...
            null,
            null
        ) to "[34.423421,120.456787,null,null,null]",
        LocationDataModel(
            34.423421,
            120.456787,
            10.56,
            null
        ) to "[34.423421,120.456787,10.56,null,null]",
        LocationDataModel(
            34.423421,
            120.456787,
            10.56,
            Poi.Unnamed(address = "Address")
        ) to "[34.423421,120.456787,10.56,\"Address\",null]",
        LocationDataModel(
            34.423421,
            120.456787,
            10.56,
            Poi.Named(name = "Name", address = "Address")
        ) to "[34.423421,120.456787,10.56,\"Address\",\"Name\"]",
        // mixed data presence
        LocationDataModel(
            34.423421,
            120.456787,
            null,
            Poi.Unnamed("Address")
        ) to "[34.423421,120.456787,null,\"Address\",null]",
        LocationDataModel(
            34.423421,
            120.456787,
            null,
            Poi.Named(name = "Name", address = "Address")
        ) to "[34.423421,120.456787,null,\"Address\",\"Name\"]",
        // negative numbers
        LocationDataModel(
            -34.423421,
            -120.456787,
        ...
        LocationDataModel(
            3.49823748927349E19,
            1.2084363284698237E20,
            null,
            null
        ) to "[3.49823748927349E19,1.2084363284698237E20,null,null,null]",
        LocationDataModel(
            3.49823748927349E19,
            1.2084363284698237E20,
            1.2378216376128731E19,
            null
        ) to "[3.49823748927349E19,1.2084363284698237E20,1.2378216376128731E19,null,null]",
        // line breaks
        LocationDataModel(
            34.423421,
            120.456787,
            10.56,
            Poi.Named(name = "Name", address = "Cool Street\nCool City")
        ) to "[34.423421,120.456787,10.56,\"Cool Street\\nCool City\",\"Name\"]",
        LocationDataModel(
            34.423421,
            120.456787,
            10.56,
        ...
        LocationDataModel(
            ...
            120.456787,
            10.56,
            Poi.Named(name = "   ", address = "     ")
        ) to "[34.423421,120.456787,10.56,\"     \",\"   \"]",
    )
    ...
    private val testCasesFromString: List<Pair<String, LocationDataModel>> = listOf(
        ...
        // with poiAddress
        "[10.5, 20.0, 30.0, \"Address\"]" to LocationDataModel(
            10.5,
            20.0,
            30.0,
            Poi.Unnamed("Address")
        ),
        "[10.5, 20.0, 30.0, \"Address\", null]" to LocationDataModel(
            10.5,
            20.0,
            30.0,
            Poi.Unnamed("Address")
        ),
        "[10.5, 20.0, null, \"Address\", null]" to LocationDataModel(
            10.5,
            20.0,
            null,
            Poi.Unnamed("Address")
        ),
        "[10.5, 20.0, null, \"Address\"]" to LocationDataModel(
            10.5,
            20.0,
            null,
            Poi.Unnamed("Address")
        ...
        // with poiName
        "[10.5, 20.0, 30.0, \"Address\", \"Name\"]" to LocationDataModel(
            10.5,
            20.0,
            30.0,
            Poi.Named("Name", "Address")
        ),
        "[10.5, 20.0, null, \"Address\", \"Name\"]" to LocationDataModel(
            10.5,
            20.0,
            null,
            Poi.Named("Name", "Address")
        ...
        "[10.5, 20.0, 30.0, \"Address\", \"Name\", 50.0, {}, []]" to LocationDataModel(
            10.5,
            20.0,
            30.0,
            Poi.Named("Name", "Address")
