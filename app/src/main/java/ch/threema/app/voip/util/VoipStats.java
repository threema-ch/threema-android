...
public class VoipStats {
	...
	private static class StateContext {
		@Nullable final State previousState;
		double timestampUs;
	...
	public static class Extractor {
		private @NonNull final Builder builder;
	...
	public static class BytesTransferred implements VoipStats.StatsRepresentation {
		@Nullable final public BigInteger sent;
		@Nullable final public BigInteger received;
	...
	public static class RoundTripTime implements VoipStats.StatsRepresentation {
		@Nullable final public Double latest;
		@Nullable final public Double average;
	...
	public static class Candidate implements VoipStats.StatsRepresentation {
		@Nullable final public String address;
		@Nullable final public String type;
		@Nullable final public String protocol;
		@Nullable final public String network;
	...
	public static class CandidatePair implements VoipStats.StatsRepresentation {
		...
		@NonNull final public String id;
		@NonNull final public BigInteger priority;
		@Nullable final public Candidate local;
		@Nullable final public Candidate remote;
		@Nullable final public Boolean nominated;
		@Nullable final public String state;
		@NonNull final public VoipStats.BytesTransferred bytesTransferred;
		@NonNull final public VoipStats.RoundTripTime roundTripTime;
		@Nullable final public Double availableOutgoingBitrate;
	...
	public static class Transport implements VoipStats.StatsRepresentation {
		@NonNull final public VoipStats.BytesTransferred bytesTransferred;
		@Nullable final public String dtlsState;
		@NonNull final public String selectedCandidatePairId;
	...
	public static class Crypto implements VoipStats.StatsRepresentation {
		@NonNull final public String dtlsVersion;
		@Nullable final public String dtlsCipher;
		@Nullable final public String srtpCipher;
	...
	public abstract static class Rtp implements VoipStats.StatsRepresentation {
		@NonNull final private SortedMap<String, Codec> codecs;
		@Nullable final public String codecId;
		@Nullable final public String kind;
		@Nullable public Double jitter;
		@Nullable public Long packetsTotal;
		@Nullable public BigInteger bytesTotal;
		@Nullable public Integer packetsLost;
		@Nullable public Float packetLossPercent;
		@Nullable public String qualityLimitationReason;
		@Nullable public Long qualityLimitationResolutionChanges;
		@Nullable public String implementation;
		@Nullable public Float averageFps;
		@Nullable public Double bitrate;
	...
	public static class Track implements VoipStats.StatsRepresentation {
		@Nullable final public String kind;
		@Nullable final public Long frameWidth;
		@Nullable final public Long frameHeight;
		@Nullable final public Long freezeCount;
		@Nullable final public Long pauseCount;
	...
	public enum CodecMimeTypePrimary {
		...
		@NonNull public static CodecMimeTypePrimary fromRepresentation(@Nullable String string) {
			if (string == null) {
				return UNKNOWN;
			}
			switch (string) {
		...
		@NonNull public String toShortRepresentation() {
			switch (this) {
				case AUDIO:
					return "a";
				case VIDEO:
		...
		@NonNull public String toRepresentation() {
			switch (this) {
				case AUDIO:
					return "audio";
				case VIDEO:
	...
	public static class CodecMimeType {
		@NonNull final public CodecMimeTypePrimary primary;
		@NonNull final public String secondary;
	...
	public static class Codec implements VoipStats.StatsRepresentation {
		@NonNull final public String id;
		@NonNull final public Direction direction;
		@NonNull final public CodecMimeType mimeType;
		@Nullable final public Long clockRate;
		...
		@NonNull CodecMimeType getMimeType(@Nullable String mimeTypeString) {
	...
	public static class RtpTransceiver implements VoipStats.StatsRepresentation {
		@NonNull final private org.webrtc.RtpTransceiver transceiver;
	...
	@NonNull private final Extractor extractor;
	@NonNull private final Builder builder;
	@NonNull private final StateContext context;
	@NonNull private final Map<String, RTCStats> stats;

	@Nullable public VoipStats.CandidatePair selectedCandidatePair = null;
	@Nullable public VoipStats.Transport transport = null;
	@Nullable public VoipStats.Crypto crypto = null;
	@Nullable public VoipStats.InboundRtp inboundRtpAudio = null;
	@Nullable public VoipStats.InboundRtp inboundRtpVideo = null;
	@Nullable public VoipStats.OutboundRtp outboundRtpAudio = null;
	@Nullable public VoipStats.OutboundRtp outboundRtpVideo = null;
	@Nullable public VoipStats.Track inboundTrackVideo = null;
	@Nullable public VoipStats.Track outboundTrackVideo = null;
	@Nullable public SortedMap<String, Codec> inboundCodecs = null;
	@Nullable public SortedMap<String, VoipStats.Codec> outboundCodecs = null;
	@Nullable public List<RtpTransceiver> rtpTransceivers = null;
	@Nullable public List<VoipStats.CandidatePair> candidatePairs = null;
