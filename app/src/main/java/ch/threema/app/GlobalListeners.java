...
public class GlobalListeners {
    ...
    public void setUp() {
        ...
        ListenerManager.groupJoinResponseListener.add((outgoingGroupJoinRequestModel, status) ->
            serviceManager.getNotificationService()
                .showGroupJoinResponseNotification(
                    outgoingGroupJoinRequestModel, status, serviceManager.getDatabaseService()
                ));
        ...
        WebClientListenerManager.wakeUpListener.add(() -> Toaster.Companion.showToast(R.string.webclient_protocol_version_to_old, Toaster.Duration.LONG));
