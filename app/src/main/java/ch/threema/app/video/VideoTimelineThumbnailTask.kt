...
class VideoTimelineThumbnailTask(
    ...
    override fun run() {
        ...
        try {
            inputVideoComponent =
                MediaComponent(context, mediaItem.uri, MediaComponent.COMPONENT_TYPE_VIDEO)
            ...
            if (mediaFormat != null) {
                ...
                if (outputDimensions != null) {
                    ...
                    outputSurface =
                        OutputSurface(outputDimensions.width, outputDimensions.height, 0)
                    ...
                    decoder.start()
                    extractThumbnails(
                        inputVideoComponent.mediaExtractor,
                        decoder,
                        outputSurface,
