...
public class LocationAutocompleteAdapter extends EmptyRecyclerView.Adapter<EmptyRecyclerView.ViewHolder> {
    ...
    private List<NamedPoi> places;
    private OnItemClickListener onItemClickListener;

    LocationAutocompleteAdapter(List<NamedPoi> places) {
        this.places = places;
    }

    public void setPlaces(@NonNull List<NamedPoi> places) {
        this.places = places;
    }
    ...
    public class PlacesViewHolder extends EmptyRecyclerView.ViewHolder {
        ...
        void onBind(int position) {
            ...
            final NamedPoi place = places.get(position);
    ...
    public interface OnItemClickListener {
        void onClick(NamedPoi poi, int position);
    }
}
